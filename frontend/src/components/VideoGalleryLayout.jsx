...
// Se abre en pestaña nueva (window.open), no embebido, así que HTTP no da mixed
// content. gradio.mystherai.com NO sirve — es la app React. Override con
// VITE_GRADIO_URL si se monta un proxy HTTPS a :7860.
                                ...
                                user && !user.is_staff ? (
                                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
                                    ...
                                    <button
                                      ...
                                      onClick={() => handleReservar(selectedVideo.id)}
                              ...
                              {est === 'Reservado' && (
                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
                                  ...
                                  {(user?.is_staff || user?.display_name?.toLowerCase() === selectedVideo.reservado_por?.toLowerCase()) && (
                                    <button
                                      disabled={reservaLoading}
                                      onClick={() => handleLiberar(selectedVideo.id)}
